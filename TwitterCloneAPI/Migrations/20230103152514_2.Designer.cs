            ...
            modelBuilder.Entity("TwitterCloneAPI.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Text = "prufa comment",
                            Timestamp = new DateTime(2023, 1, 3, 15, 25, 13, 967, DateTimeKind.Local).AddTicks(9702),
                            TweetId = 1,
                            UserId = 1
                        },
                        new
                        {
                            CommentId = 2,
                            Text = "prufa comment2",
                            Timestamp = new DateTime(2023, 1, 3, 15, 25, 13, 967, DateTimeKind.Local).AddTicks(9724),
                            TweetId = 2,
                            UserId = 2
                        },
                        new
                        {
                            CommentId = 3,
                            Text = "prufa comment3",
                            Timestamp = new DateTime(2023, 1, 3, 15, 25, 13, 967, DateTimeKind.Local).AddTicks(9736),
                            TweetId = 2,
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("TwitterCloneAPI.Models.Tweet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2023, 1, 3, 15, 25, 13, 967, DateTimeKind.Local).AddTicks(9659),
                            UserId = 2
                        },
                        new
                        {
                            ...
                            Timestamp = new DateTime(2023, 1, 3, 15, 25, 13, 967, DateTimeKind.Local).AddTicks(9691),
                            UserId = 1
                        });
                });
